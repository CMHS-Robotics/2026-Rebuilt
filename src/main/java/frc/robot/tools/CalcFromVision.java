...
public class CalcFromVision {
    ...
    public Optional<Double> calcHubRPM() {
        ...
        // only center
        Optional<Translation2d> centerTranslation = vision.translationToTagFromPose(centerTag);
    ...
    //         Optional<Translation2d> leftTranslation = vision.translationToTagFromPose(leftTag);
