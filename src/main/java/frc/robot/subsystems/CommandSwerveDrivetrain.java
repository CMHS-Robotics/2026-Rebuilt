...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public void seedFieldCentric() {
        ...
        setOperatorPerspectiveForward(current);
    }
    ...
    public void periodic() {
         ...
         */
        if (!m_hasAppliedOperatorPerspective || DriverStation.isDisabled()) { // removed || DriverStation.isDisabled() because otherwise it does every disable
        ...
        SmartDashboard.putNumber("gyroPosition", getState().Pose.getRotation().getDegrees());
    }
...
public void addVisionMeasurement(Pose2d visionRobotPoseMeters, double timestampSeconds, Matrix<N3, N1> visionMeasurementStdDevs) {
    System.out.println("DRIVETRAIN RECEIVED: " + visionRobotPoseMeters.getX());
